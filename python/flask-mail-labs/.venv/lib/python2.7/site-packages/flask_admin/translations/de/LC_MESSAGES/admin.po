# German translations for Flask-Admin.
...
"Report-Msgid-Bugs-To: git@winniehell.de\n"
...
msgstr "Verzeichnis \"%s\" wurde erfolgreich gelöscht."
...
msgstr "Model wurde erfolgreich erstellt."
...
msgstr "Sind Sie sicher, dass Sie \\'%(name)s\\' rekursiv löschen wollen?"

#: ../flask_admin/templates/admin/file/list.html:63
#, python-format
msgid "Are you sure you want to delete \\'%(name)s\\'?"
msgstr "Sind Sie sicher, dass Sie \\'%(name)s\\' löschen wollen?"
...
msgstr "Bitte geben Sie einen Namen für %(name)s an"
